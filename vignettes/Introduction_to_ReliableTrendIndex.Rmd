...
In this data, the RTI identifies `r sum(sim_data_1$category.RCI != "Unspecified")` people as "reliably" changed Compared to the `r sum(sim_data_1$category.RTI != "Unspecified")` of the RCI. 
...
* `r sum(sim_data_1$true_change == "True Decrease" & sim_data_1$category.RTI == "Reliable Decrease" & sim_data_1$category.RCI == "Unspecified")` people who truly decreased were identified correctly by the RTI but 'Unspecified' by the RCI. In contrast, the RCI identified `r sum(sim_data_1$true_change == "True Decrease" & sim_data_1$category.RCI == "Reliable Decrease" & sim_data_1$category.RTI == "Unspecified")` person who truly decreased while the RTI said they were 'Unspecified.'   
